...
## Part 1: Introductions, setup, & workshop overview {.content-light}
...
![](images/Andrie%20square%20500px.jpg){width="278"}
...
![](images/michaelmayer-scaled.jpg){width="154"}
...
<br> **Optional: (for local development)**\
...
<iframe src="https://giphy.com/embed/26xBziMPJcCmBbpVm" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>

## Part 2: DevOps Principles & Tools {.content-light}
...
![](images/pheonix_project.png){fig-align="left" width="200"}

![](images/devops.jpg){fig-align="right" width="200"}
...
![](images/cicd.png){fig-align="center"}
...
![](images/Screenshot%202023-08-23%20at%2011.20.04%20AM.png){fig-align="center"}
...
**Package** - contains code, functions, data, and documentation. <br>

**Library** - is a directory where packages are installed. <br>
...
+-----------------------------+------------------------------------------+-----------------------------------------------------------+
| External Database           | Container remains stateless;             |                                                           |
|                             |                                          |                                                           |
