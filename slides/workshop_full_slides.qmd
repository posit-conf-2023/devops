...
:::{.notes}
-   client-server architecture. The Docker client - which is the primary way that users interface with Docker via CLI - talks to the Docker daemon, which does the heavy lifting of building, running, and distributing your Docker containers.
...
```
:::{.notes}
docker image of a http web server created by Apache
:::
