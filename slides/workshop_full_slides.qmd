...
::: notes
these are the ones that we're going to be covering - definitely not going to be a complete overview - but in my opinion the most important tool types to get you started quickly. We will also be discussing this in the context of ds and how these types of tools can fit in a data workflow - and hopefully improve it.
:::
...
-   So CI/CD is often said together - as it makes up a continuous pipeline as one word - but its actual pretty discrete parts so I want to make sure we understand how they differ.
...
::: notes
prod-identical - docker, kubernetes, other container services

IaC - quickly reprovision your entire environment with code (chef, puppet, dockr, terraform, ansible
...
-   Docker compose [yaml](https://github.com/rstudio/rstudio-docker-products/blob/dev/docker-compose.ym) to spin up all 3 Posit Pro products

::: footer
🔍 Live code
:::

## Lab Activity - Inspect your YAML
