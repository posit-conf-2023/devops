...
-   this workshop will involve us working in a linux environment
-   if you need a refresher on linux commands
-   linux commands will be provided in all lab and exercise materials

## Linux Refresher (optional section) {.toc-people-dark}
...
## Show images of a few different types of CI workflows
...
::: notes
live code a quick renv on workbench instead of going through all the steps
:::
...
Complete Part 1: Exercises 1 - 8

## Docker ports & localhost
...
Complete Part 1: Exercises 9 - 10
...
## Layers of a Dockerfile

Walk through Posit Connect Dockerfile or Shiny Server
