...
-   Lab #1: Deployed your own Quarto website on Github Pages using GitHub Actions CI/CD

-   Lab #2: Written your own Dockerfile to deploy Open Source Shiny Server on [Docker playground](https://labs.play-with-docker.com/) and hosted an app on the server

-   Lab #3: Created an API wrapper around a trained prediction model and hosted it on Posit Connect
...
|                                    | Introductions                                    |                                                                                                                                                                   |
+------------------------------------+--------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Part 2: Devops Principles          | Introduction to Devops                           | Lab 1: Deployed your own Quarto website on Github Pages using GitHub Actions CI/CD                                                                                |
|                                    |                                                  |                                                                                                                                                                   |
|                                    | Version Control                                  |                                                                                                                                                                   |
|                                    |                                                  |                                                                                                                                                                   |
|                                    | CI/CD                                            |                                                                                                                                                                   |
...
+------------------------------------+--------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Part 3: Docker for Data Scientists | Docker: Overview and architecture                | Lab #2: Written your own Dockerfile to deploy Open Source Shiny Server on [Docker playground](https://labs.play-with-docker.com/) and hosted an app on the server |
|                                    |                                                  |                                                                                                                                                                   |
|                                    | Building Docker images and containers            |                                                                                                                                                                   |
|                                    |                                                  |                                                                                                                                                                   |
|                                    | Ports & Networking 101                           |                                                                                                                                                                   |
|                                    |                                                  |                                                                                                                                                                   |
|                                    | How data scientists can use docker in production |                                                                                                                                                                   |
+------------------------------------+--------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Part 4: Data Science in Production | Choosing your deployment method                  | Lab #3: Created an API wrapper around a trained prediction model and hosted it on Posit Connect                                                                   |
|                                    |                                                  |                                                                                                                                                                   |
...
Bonus Materials: Linux Refresher
...
-   Runs on a separate server called a runner
...
Complete Part 4 of Lab: Deploy Quarto with GHA including the exercises

## Introduction to Docker

-   Enhances DevOps practices by promoting consistency and reproducibility.
-   Open platform portable tool that allows you to package and application and its dependencies in a unit called a container.
-   Create isolated environments for different experiments.
-   Share work with colleagues without environment setup issues.
-   Enables easier testing in production-like environments.
...
![](images/docker%20lifecycle.webp)

-   credit - docker for java developers

## Docker Architecture

-   ![](images/Screenshot%202023-08-30%20at%2011.31.56%20AM.png)client-server architecture. The Docker client talks to the Docker daemon, which does the heavy lifting of building, running, and distributing your Docker containers.
...
-   Client is primary way that users interact with Docker via CLI.

-   Registry is a Repository for Docker images (e.g., Docker Hub) where you can store and share images.

## Building Docker Images

-   an image is a **read-only** system that includes files + meta-data

-   made of layers stacked on top of each other

-   When you want to run a container, you *pull* the image and run it as an *instance*, which is what you\'ll actually interact with.

-   Containers are ephemeral - once it shuts down all the information inside of it removed.
