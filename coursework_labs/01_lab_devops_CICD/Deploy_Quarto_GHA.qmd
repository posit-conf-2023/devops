...
7.  Configure your github information in the terminal. To set your global commit name and email address run the `git config` command with the `--global` option:
...
8.  Create a branch with `git checkout -b gh-pages`. You can use `git checkout <branch_name>` to move between existing branches.
...
1.  Create a .github/workflows folders in your main directory
...
2.  Add a .gitignore file in your main directory and add the following:
...
4.  Go to your repository on github and maneuver to Settings \> Pages.

5.  Change your Source branch to Github Actions from root
