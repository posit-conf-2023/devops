...
4.  Install and initialize an `renv` workflow. Inspect the lock file. Where are packages being pulled from? Confirm by typing `options("repos")`. Does this differ from the repo set in Tools \> Global Options \> Packages?
...
5.  Learning how to use all the power of Quarto is beyond the scope of the workshop but you should still take 10-15 minutes to play around with your new website. Use the below resources to try out difference templates and options.
...
## Part: Version Control and Authentication with Github
