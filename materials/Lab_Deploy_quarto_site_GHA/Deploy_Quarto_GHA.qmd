...
2.  To create a new website project within RStudio, click on **File** \> **New Project** \> **Quarto Website** and save it to a directory with a name.
    ...
    Check out the quarto website [page](https://quarto.org/docs/websites/#workflow) to learn more about the website workflow and structure of the file system.
    :::
...
4.  Install the `renv` package and Run `renv::init` in your console to initialize a new project-local environment with a private R library. Once you do this you will see a new file called `renv.lock` has been created in your project directory along with an `renv` folder.
    ...
    1.  Inspect the lock file. Where are packages being pulled from? Confirm by typing `options("repos")`. Does this differ from the repo set in Tools \> Global Options \> Packages?
