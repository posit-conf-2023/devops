...
4.  Install and initialize an `renv` workflow.
...
-   Make a list of the layers that need to be reproduced in this workflow.
    ...
    -   Where are packages being pulled from? Confirm by typing `options("repos")`. Does this differ from the repo set in Tools \> Global Options \> Packages? You can modify your package repository by running `options("repos" = c("<REPO-NAME>" = "https://your-repository-url.com"))` in your RStudio console.
...
6.  (**Optional)** Learning how to use all the power of Quarto is beyond the scope of the workshop but you can take some time to play around with your new website. Use the below resources to try out difference templates and options.
...
## Part 2: Version Control and Authentication with Github
